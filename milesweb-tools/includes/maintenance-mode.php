    ...
    if (get_option('maintenance_mode_enabled', false)) {
        ...
        <body class="mainbodytag">
            <div class="coming-soon">
                <a href="https://www.milesweb.in/?utm_source=maintenance-mode&utm_medium=maintenance-mode-external-website" target="_blank"><?php echo wp_kses_post($logo_img); ?></a>
                ...
                <a class="coming-soon-a" href="mailto:<?php echo esc_attr(get_bloginfo('admin_email')); ?>"><?php echo esc_html__('Contact Us', 'milesweb-tools'); ?></a>
            </div>
            <?php wp_footer(); ?>
        </body>
        </html>
